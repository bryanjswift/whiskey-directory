...
<pre><code>
	scala -cp target/whiskey-directory/WEB-INF/lib/*:target/whiskey-directory/WEB-INF/classes/:target/test-classes/:src/test/lib/* {SpecificationObject}
...
<pre><code>
	scala -cp target/whiskey-directory/WEB-INF/lib/*:target/whiskey-directory/WEB-INF/classes/:target/test-classes/:src/test/lib/* com.whiskeydirectory.model.DrinkSpecs
